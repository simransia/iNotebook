...
const About = () => {
  ...
  return <div className="container">
    ...
    <ul className="list-group list-group-flush list-group-numbered mx-5">
      <li className="list-group-item">Write your personal or proffesional notes</li>
      ...
      <li className="list-group-item">Access your notes from anywhere or from any devices</li>
